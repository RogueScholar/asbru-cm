...
- Right mouse click on tab title stop working
...
- added execute cluster commit on confirmed if confirmation was required
...
- Installing on fedora not working
...
- \[gtk3\] Local shell colors not remembered
